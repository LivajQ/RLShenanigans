...
public class PotionGolemBad extends PotionBase {
    
    public static final PotionGolemBad INSTANCE = new PotionGolemBad();
    
    public PotionGolemBad() {
        super("GolemBad", false, 0xFFC0CB);
    }
